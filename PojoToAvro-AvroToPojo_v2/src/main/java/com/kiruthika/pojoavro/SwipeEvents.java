...
public class SwipeEvents extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4090116406382276238L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SwipeEvents\",\"namespace\":\"com.kiruthika.pojoavro\",\"fields\":[{\"name\":\"dept\",\"type\":[\"null\",\"string\"]},{\"name\":\"empId\",\"type\":{\"type\":\"int\",\"java-class\":\"java.lang.Integer\"}},{\"name\":\"eventName\",\"type\":[\"null\",\"string\"]},{\"name\":\"swipeTime\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public SwipeEvents(java.lang.CharSequence dept, java.lang.Integer empId, java.lang.CharSequence eventName, java.lang.CharSequence swipeTime) {
    this.dept = dept;
    this.empId = empId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: eventName = (java.lang.CharSequence)value$; break;
   ...
   */
  public static com.kiruthika.pojoavro.SwipeEvents.Builder newBuilder() {
    return new com.kiruthika.pojoavro.SwipeEvents.Builder();
  }
   ...
   * @return A new SwipeEvents RecordBuilder
   */
  public static com.kiruthika.pojoavro.SwipeEvents.Builder newBuilder(com.kiruthika.pojoavro.SwipeEvents.Builder other) {
    if (other == null) {
      return new com.kiruthika.pojoavro.SwipeEvents.Builder();
    } else {
      return new com.kiruthika.pojoavro.SwipeEvents.Builder(other);
    }
  }
   ...
   * @return A new SwipeEvents RecordBuilder
   */
  public static com.kiruthika.pojoavro.SwipeEvents.Builder newBuilder(com.kiruthika.pojoavro.SwipeEvents other) {
    if (other == null) {
      return new com.kiruthika.pojoavro.SwipeEvents.Builder();
    } else {
      return new com.kiruthika.pojoavro.SwipeEvents.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SwipeEvents>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kiruthika.pojoavro.SwipeEvents.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kiruthika.pojoavro.SwipeEvents other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.dept)) {
        this.dept = data().deepCopy(fields()[0].schema(), other.dept);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kiruthika.pojoavro.SwipeEvents.Builder setDept(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kiruthika.pojoavro.SwipeEvents.Builder clearDept() {
      dept = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kiruthika.pojoavro.SwipeEvents.Builder setEmpId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kiruthika.pojoavro.SwipeEvents.Builder clearEmpId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kiruthika.pojoavro.SwipeEvents.Builder setEventName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kiruthika.pojoavro.SwipeEvents.Builder clearEventName() {
      eventName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kiruthika.pojoavro.SwipeEvents.Builder setSwipeTime(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kiruthika.pojoavro.SwipeEvents.Builder clearSwipeTime() {
      swipeTime = null;
    ...
    public SwipeEvents build() {
      try {
        ...
        record.eventName = fieldSetFlags()[2] ? this.eventName : (java.lang.CharSequence) defaultValue(fields()[2]);
